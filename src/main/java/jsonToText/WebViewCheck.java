...
public class WebViewCheck extends Application {
    ...
    public void start(Stage stage) {
        ...
        scene = new Scene(new BrowserR(), 750, 500, Color.web("#666970"));
...
class BrowserR extends Region {
    ...
    private static String[] urls = new String[]{
        ...
        WebViewCheck.class.getResource("help.html").toExternalForm()
    };
