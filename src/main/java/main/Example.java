...
public class Example {
	...
	public static void main(String[] args) {
		...
		String url = "https://www.thomann.de/de/index.html";
		driver.get(url);
		try {
			makeFullScreenshot(driver,"example.png");
			driver.quit();
		} catch (IOException e) {
 ...
 private static final String JS_RETRIEVE_DEVICE_PIXEL_RATIO = "var pr = window.devicePixelRatio;"
 		+ " if (pr != undefined && pr != null)return pr; else return 1.0;";
